...
exp_name="debug_all_dep0.025_clamp0.5_knn0.005_prendoold_wotv_dxyz_dcol_depth1.0_knn0.01_centerline"

PYTHONPATH='.'  python train.py -s data/c1_ascending_t4_v4 --port 6019 --expname $exp_name --no_ds --no_do --no_dr --depth_weight 1.0 --tv_weight 0 --knn_weight 0.01 --iterations 30000
